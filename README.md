...
## 🧠 About Me
- 💡 Building AI-powered projects (Resume Analyzer, Career Tools)
- 🎮 Organized Ideathon at MS OFFICE NOIDA 
- 🚀 Interested in Hackathons & Real-world Problem Solving

---

## 🛠 Tech Stack
![Tech](https://skillicons.dev/icons?i=cpp,python,js,react,nodejs,git)

---

## 🚀 Featured Projects
- 🔥 AI Resume Analyzer (with job matching + skill gap)
- 🌐 Portfolio Website
